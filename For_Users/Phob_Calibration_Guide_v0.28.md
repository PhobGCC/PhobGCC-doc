...
For Version 0.27, use [this document](https://github.com/pokeimon/PhobGCC-doc/blob/main/For_Users/Phob_Calibration_Guide_v0.27.md).
...
* If the controller doesn't show 28, then you need to reference an older configuration document [here](https://github.com/pokeimon/PhobGCC-doc/blob/main/LEGACY.md).
