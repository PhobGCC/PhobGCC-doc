...
* The ability to flash the PhobGCC firmware normally by following the [Phob Programming Guide](https://github.com/pokeimon/PhobGCC-doc/blob/main/For_Users/Phob_Programming_Guide.md).
